...
# Format:
# drop_off_bay, bay_latch, motion, turn_dir, turn_state, turn_complete, unloading_state = LHS_dropoff(resistor_color, S1, S2, SL, SR, new_junction, new_T, drop_off_bay, bay_latch, motion, turn_state, turn_dir, turn_complete, unloading_state)            
