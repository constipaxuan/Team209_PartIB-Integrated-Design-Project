...
#i2c_R = I2C(id=1, sda=Pin(10), scl=Pin(11), freq=100000) # I2C1 on GP10 & GP11

#print("RIGHT scan =", i2c_R.scan())
...
i2c_L = I2C(id=0, sda=Pin(8), scl=Pin(9), freq = 100000) # I2C0 on GP8 & GP9
print("RIGHT scan =", i2c_L.scan())
